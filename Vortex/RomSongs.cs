...
namespace Vortex
{
	public static class RomSongs
	{
		public static EventType[] EventTypes = new EventType[]
		{
			...
			new EventType { Value = 0xe5, Length = 0x02, Name = "CallSubroutine" },
			...
			new EventType { Value = 0xef, Length = 0x03, Name = "RepeatSubroutine" },
		...
		public const int LastNote = 0xBF;
		public const int Tie = 0xC8;
		public const int FirstRest = 0xC9;
		public const int LastRest = 0xC9;
		public const int FirstPercussion = 0xCA;
		public const int LastPercussion = 0xCD;
		public const int FirstEvent = 0xCE;
		public const int LastEvent = 0xF0;
